                ...
                this.projectService.find(id)
                    .subscribe((projectResponse: HttpResponse<Project>) => {
                        ...
                        if (project.startYear) {
                            project.startYear = {
                                year: project.startYear.getFullYear(),
                                month: project.startYear.getMonth() + 1,
                                day: project.startYear.getDate()
                            };
                        }
                        if (project.endYear) {
                            project.endYear = {
                                year: project.endYear.getFullYear(),
                                month: project.endYear.getMonth() + 1,
                                day: project.endYear.getDate()
                            };
                        }
